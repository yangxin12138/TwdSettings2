...
public class OptionsOrConnectState
        implements State {
    private static final String TAG = "OptionsOrConnectState";
    private final FragmentActivity mActivity;
    private Fragment mFragment;

    public OptionsOrConnectState(FragmentActivity paramFragmentActivity) {
    ...
    public void processForward() {
        ...
        mFragment = null;
        ((StateMachine) new ViewModelProvider(mActivity).get(StateMachine.class)).getListener().onComplete(StateMachine.CONNECT);//5
    }
}
