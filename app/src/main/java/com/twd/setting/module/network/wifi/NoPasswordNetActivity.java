 ...
 * @Author:Yangxin
 * @Description:
 * @time: Create in 上午11:00 22/4/2025
 */
public class NoPasswordNetActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void connectToWifi(String ssid){
        ...
        Log.i("yangxin_nopassword", "connectToWifi: SSID = " + wifiConfiguration.SSID);
        wifiConfiguration.allowedKeyManagement.set(WifiConfiguration.KeyMgmt.NONE);
        WifiManager wifiManager = (WifiManager) getApplicationContext().getSystemService(Context.WIFI_SERVICE);
        Log.i("yangxin_nopassword", "connectToWifi: wifiManager = " + wifiManager);
        ...
        if (networkId != -1) {
            Log.i("yangxin_nopassword", "进入内部连接 " + wifiManager);
            // 断开当前连接
            ...
            Log.i("yangxin_nopassword", "配置失败 ssid = " + ssid);
        }
    ...
    private String getCurrentWifiSsid(WifiManager wifiManager){
        ...
        if (wifiInfo != null && wifiInfo.getSupplicantState() == SupplicantState.COMPLETED){
            ...
            Log.i("yangxin_nopassword", "getCurrentWifiSsid connectToWifi: ssid = " + ssid);
        }else {
            Log.i("yangxin_nopassword", "getCurrentWifiSsid connectToWifi: ssid = 333330");
            ssid = "NoConnect";
        }
        return ssid;
    }
